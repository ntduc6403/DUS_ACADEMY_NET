    ...
    public class AdsController : BaseController
    {
        ...
        public ActionResult AddAds(AdsDTO model)
        {
            ...
            else if (ModelState.IsValid)
            {
                ...
                if (ext == ".jpg" || ext == ".jpeg" || ext == ".png" || ext == ".gif")
                {
                    ...
                    resizeImage.Save(Server.MapPath("~/Areas/Admin/Content/QC_Image/" + filename));
        ...
        public ActionResult UpdateAds(AdsDTO model)
        {
            ...
            else
            {
                ...
                if (model.AdsImage != null)
                {
                    if (System.IO.File.Exists(Server.MapPath("~/Areas/Admin/Content/QC_Image/" + oldImagePath)))
                    {
                        System.IO.File.Delete(Server.MapPath("~/Areas/Admin/Content/QC_Image/" + oldImagePath));
                    }
                }
        ...
        public JsonResult DeleteAds(int ID)
        {
            ...
            if (System.IO.File.Exists(Server.MapPath("~/Areas/Admin/Content/QC_Image/" + imagepath)))
            {
                System.IO.File.Delete(Server.MapPath("~/Areas/Admin/Content/QC_Image/" + imagepath));
            }
            return Json("");
        }
