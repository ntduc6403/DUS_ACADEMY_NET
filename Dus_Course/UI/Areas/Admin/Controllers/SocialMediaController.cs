...
namespace UI.Areas.Admin.Controllers
{
    public class SocialMediaController : BaseController
    {
        ...
        public ActionResult AddSocialMedia(SocialMediaDTO model)
        {
            ...
            {
                // khai báo một biến postedfile và gán giá trị cho nó từ một thuộc tính của đối tượng model, nơi tập tin hình ảnh được lưu dưới dạng HttpPostedFileBase.
                // Đây là kiểu dùng để đại diện cho một tập tin được người dùng gửi lên từ một form web.
